...
static auto runAllTests() -> int {
  return testcpplite::test(
      {{parse::zeroAsUsd, "parse zero (0) as USD"},
       ...
       {test::format::zeroDollars, "format zero dollars"},
       {test::format::oneDollar, "format one dollar"},
       {test::format::oneCent, "format one cent"},
       {test::format::tenCents, "format ten cents"},
       {test::format::negativeOneDollarThirtyFourCents,
        "format negative one dollar and thirty-four cents"},
       {test::format::negativeFifteenCents, "format negative fifteen cents"},
