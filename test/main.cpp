...
static auto runAllTests() -> int {
  return testcpplite::test(
      {{parse::zeroAsUsd, "parse zero (0) as USD"},
       ...
       {command_line::evaluate::print, "evaluate print command"},
       {command_line::evaluate::transferTo, "evaluate transfer to command"},
       {command_line::evaluate::debit, "evaluate debit"},
       {command_line::evaluate::debitPromptsForDate,
        "evaluate debit prompts for date"},
       {command_line::evaluate::debitPromptsForDesriptionAfterDateEntered,
        "evaluate debit prompts for description after date entered"},
       {command_line::evaluate::debitShowsTransaction,
        "evaluate debit shows transaction"},
       {command_line::evaluate::credit, "evaluate credit"},
       {command_line::evaluate::save, "evaluate save"},
       {command_line::evaluate::load, "evaluate load"},
