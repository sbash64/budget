...
static auto runAllTests() -> int {
  return testcpplite::test(
      {{parse::zeroAsUsd, "parse zero (0) as USD"},
       ...
       {bank::debitsNonexistentAccount, "bank debits nonexistent account"},
       ...
       {bank::removeDebitFromNonexistentAccountDoesNothing,
        "bank remove debit from nonexistent account does nothing"},
